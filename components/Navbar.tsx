    ...
    <>
      ...
      >
        <ul className='w-full md:w-100 flex items-center justify-between md:justify-start'>
          ...
          <li className='px-4'>
            <Link href='/'>
              <a className='font-apercu text-7xl font-extrabold uppercase'>
                Toppy
              </a>
            </Link>
          </li>
        ...
        >
          <li className='relative z-0 hover:cursor-pointer my-8 md:my-auto'>
            <Link href='/about'>
              ...
              >
                <a className='font-apercu text-2xl font-extrabold uppercase'>
                  About
                </a>
              </span>
            </Link>
          ...
          <li className='md:hidden xl:block relative z-0 hover:cursor-pointer my-8 md:my-auto'>
            <Link href='https://theerut-top-resume.vercel.app/'>
              <span
                className={`block hover:bg-white ${buttonShadowClass} ${buttonClass}`}
              >
                <a className='font-apercu text-2xl font-extrabold uppercase'>
                  Resume
                </a>

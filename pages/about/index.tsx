        ...
        <article className='p-8 md:p-16'>
          ...
          <div className='flex flex-col items-center md:items-start md:flex-row'>
            <aside className='py-8 md:py-24 space-x-8 w-fit'>
              <div className='animate-spin-slow w-36 h-36 md:w-96 md:h-96 bg-bright-yellow rounded-full transition-transform'></div>
            </aside>
            <div className='md:px-8'>
              <p className='font-apercu text-lg md:text-xl lg:text-3xl my-8 md:my-16'>
                ...
                currently working at Accenture, where I&apos;m leading the AI
                Chatbot project, a conversational AI Platform for Financial
                Services.
              </p>
              <p className='font-apercu text-lg md:text-xl lg:text-3xl my-8 md:my-16 text-emerald-400'>
                I&apos;m passionate about bringing groundbreaking technical
                solutions to people through intuitive experiences as well as
              ...
              <p className='font-apercu text-lg text-yellow-300 md:text-xl lg:text-3xl my-8 md:my-16'>
                I also enjoy spending my weekends to build weird and wonderful
                side projects.
              </p>
              <p className='font-apercu text-lg md:text-xl lg:text-3xl my-8 md:my-16 text-sky-400'>
                Besides coding, I have an eclectic taste in music and am
                passionate about action figures, RC cars, coding, the Internet
                of Things, and photography.
              </p>
            </div>
          </div>
        </article>
